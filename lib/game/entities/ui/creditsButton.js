var EntityCreditsButton;

EntityCreditsButton = null;

ig.module('game.entities.ui.creditsButton').requires('game.entities.baseButton', 'game.entities.ui.creditCard').defines(function() {
  return EntityCreditsButton = EntityBaseButton.extend({
