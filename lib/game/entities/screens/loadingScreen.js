var EntityLoadingScreen;

EntityLoadingScreen = null;

ig.module('game.entities.screens.loadingScreen').requires('impact.entity', 'plugins.tween', 'game.entities.ui.easyButton', 'game.entities.ui.mediumButton', 'game.entities.ui.hardButton', 'game.entities.ui.creditsButton', 'game.entities.elements.cloudOne', 'game.entities.elements.cloudTwo', 'game.entities.elements.cloudThree', 'game.entities.elements.logoShadow', 'game.entities.elements.logoBottom', 'game.entities.elements.logoMiddle', 'game.entities.elements.logoTop').defines(function() {
  return EntityLoadingScreen = ig.Entity.extend({
    ...
    update: function() {
      if (this.difficultyTimer && this.difficultyTimer.delta() > 2.5) {
        ...
        return delete this.difficultyTimer;
      }
    },
    draw: function() {
      this.parent();
      if (GAME_STATE.difficultySetting) {
        return this.moveLogoUp();
      } else {
        return this.moveLogoIn();
      }
    },
    moveLogoIn: function() {
      ...
      return this.logoShadow.tweenIn();
    },
    moveLogoUp: function() {
