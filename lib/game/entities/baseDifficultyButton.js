var EntityBaseDifficultyButton;

EntityBaseDifficultyButton = null;

ig.module('game.entities.baseDifficultyButton').requires('game.entities.baseButton', 'game.entities.elements.baseLogo').defines(function() {
  return EntityBaseDifficultyButton = EntityBaseButton.extend({
