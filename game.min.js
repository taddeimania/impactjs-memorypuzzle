...
ig.baked=true;ig.module('game.entities.food.coffee').requires('game.entities.card').defines(function(){EntityCoffee=EntityCard.extend({underCard:new ig.Image('media/cards/food/coffee.png'),value:"EntityCoffee"});});

// lib/game/entities/food/cake.js
ig.baked=true;ig.module('game.entities.food.cake').requires('game.entities.card').defines(function(){EntityCake=EntityCard.extend({underCard:new ig.Image('media/cards/food/cake.png'),value:"EntityCake"});});

// lib/game/entities/food/carrot.js
ig.baked=true;ig.module('game.entities.food.carrot').requires('game.entities.card').defines(function(){EntityCarrot=EntityCard.extend({underCard:new ig.Image('media/cards/food/carrot.png'),value:"EntityCarrot"});});

// lib/game/entities/food/apple.js
ig.baked=true;ig.module('game.entities.food.apple').requires('game.entities.card').defines(function(){EntityApple=EntityCard.extend({underCard:new ig.Image('media/cards/food/apple.png'),value:"EntityApple"});});
...
ig.baked=true;ig.module('game.entities.ui.greatJob').requires('impact.entity').defines(function(){EntityGreatJob=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/greatJob.png',853,164),size:{x:853,y:164},init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.parent(x,y,settings);}});});
