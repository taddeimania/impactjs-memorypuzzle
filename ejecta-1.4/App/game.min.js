...
this.parent();},draw:function(){this.parent();if(this.currentAnim.tile===13){this.underCard.draw(this.pos.x,this.pos.y);}},unbindClick:function(){ig.input.unbind(ig.KEY.MOUSE1,'click');},bindClick:function(){ig.input.bind(ig.KEY.MOUSE1,'click');},turnCardDown:function(){this.currentAnim=this.anims.reverseCard.rewind();this.state="down";},turnCardUp:function(){this.currentAnim=this.anims.flipCard.rewind();this.state="up";},popQueue:function(){if(!MyGame.matchOne){MyGame.matchOne=undefined;}else{MyGame.matchTwo=undefined;}},pushQueue:function(val){if(!MyGame.matchOne){MyGame.matchOne=val;}else{MyGame.matchTwo=val;if(MyGame.matchOne===MyGame.matchTwo){this.unbindClick();this.matchTimer=new ig.Timer(0.5);}else{this.unbindClick();this.noMatchTimer=new ig.Timer(0.5);}}},clearQueue:function(){MyGame.matchOne=undefined;MyGame.matchTwo=undefined;},matchFound:function(entities){this.sound.play();this.match="yes";for(var entity in entities){if(entities[entity].state==='up'){ig.game.cardCount--;entities[entity].currentAnim=this.anims.killCard.rewind();}}
...
ig.baked=true;ig.module('game.entities.animals.bird').requires('game.entities.card').defines(function(){EntityBird=EntityCard.extend({underCard:new ig.Image('media/cards/animals/bird.png'),value:"EntityBird",soundFile:"media/voices/bird.mp3"});});

// lib/game/entities/animals/cat.js
ig.baked=true;ig.module('game.entities.animals.cat').requires('game.entities.card').defines(function(){EntityCat=EntityCard.extend({underCard:new ig.Image('media/cards/animals/cat.png'),value:"EntityCat",soundFile:"media/voices/cat.ogg"});});

// lib/game/entities/animals/crab.js
ig.baked=true;ig.module('game.entities.animals.crab').requires('game.entities.card').defines(function(){EntityCrab=EntityCard.extend({underCard:new ig.Image('media/cards/animals/crab.png'),value:"EntityCrab",soundFile:"media/voices/crab.ogg"});});

// lib/game/entities/animals/dog.js
ig.baked=true;ig.module('game.entities.animals.dog').requires('game.entities.card').defines(function(){EntityDog=EntityCard.extend({underCard:new ig.Image('media/cards/animals/dog.png'),value:"EntityDog",soundFile:"media/voices/dog.ogg"});});

// lib/game/entities/animals/duck.js
ig.baked=true;ig.module('game.entities.animals.duck').requires('game.entities.card').defines(function(){EntityDuck=EntityCard.extend({underCard:new ig.Image('media/cards/animals/duck.png'),value:"EntityDuck",soundFile:"media/voices/duck.ogg"});});

// lib/game/entities/animals/fish.js
ig.baked=true;ig.module('game.entities.animals.fish').requires('game.entities.card').defines(function(){EntityFish=EntityCard.extend({underCard:new ig.Image('media/cards/animals/fish.png'),value:"EntityFish",soundFile:"media/voices/fish.ogg"});});

// lib/game/entities/animals/giraffe.js
ig.baked=true;ig.module('game.entities.animals.giraffe').requires('game.entities.card').defines(function(){EntityGiraffe=EntityCard.extend({underCard:new ig.Image('media/cards/animals/giraffe.png'),value:"EntityGiraffe",soundFile:"media/voices/giraffe.ogg"});});

// lib/game/entities/animals/lion.js
ig.baked=true;ig.module('game.entities.animals.lion').requires('game.entities.card').defines(function(){EntityLion=EntityCard.extend({underCard:new ig.Image('media/cards/animals/lion.png'),value:"EntityLion",soundFile:"media/voices/lion.ogg"});});

// lib/game/entities/animals/penguin.js
ig.baked=true;ig.module('game.entities.animals.penguin').requires('game.entities.card').defines(function(){EntityPenguin=EntityCard.extend({underCard:new ig.Image('media/cards/animals/penguin.png'),value:"EntityPenguin",soundFile:"media/voices/penguin.ogg"});});

// lib/game/entities/animals/pig.js
ig.baked=true;ig.module('game.entities.animals.pig').requires('game.entities.card').defines(function(){EntityPig=EntityCard.extend({underCard:new ig.Image('media/cards/animals/pig.png'),value:"EntityPig",soundFile:"media/voices/pig.ogg"});});

// lib/game/entities/animals/snake.js
ig.baked=true;ig.module('game.entities.animals.snake').requires('game.entities.card').defines(function(){EntitySnake=EntityCard.extend({underCard:new ig.Image('media/cards/animals/snake.png'),value:"EntitySnake",soundFile:"media/voices/snake.ogg"});});

// lib/game/entities/animals/spider.js
ig.baked=true;ig.module('game.entities.animals.spider').requires('game.entities.card').defines(function(){EntitySpider=EntityCard.extend({underCard:new ig.Image('media/cards/animals/spider.png'),value:"EntitySpider",soundFile:"media/voices/spider.ogg"});});

// lib/game/entities/animals/turtle.js
ig.baked=true;ig.module('game.entities.animals.turtle').requires('game.entities.card').defines(function(){EntityTurtle=EntityCard.extend({underCard:new ig.Image('media/cards/animals/turtle.png'),value:"EntityTurtle",soundFile:"media/voices/turtle.ogg"});});

// lib/game/entities/food/coffee.js
ig.baked=true;ig.module('game.entities.food.coffee').requires('game.entities.card').defines(function(){EntityCoffee=EntityCard.extend({underCard:new ig.Image('media/cards/food/coffee.png'),value:"EntityCoffee",soundFile:"media/voices/coffee.ogg"});});

// lib/game/entities/food/cake.js
ig.baked=true;ig.module('game.entities.food.cake').requires('game.entities.card').defines(function(){EntityCake=EntityCard.extend({underCard:new ig.Image('media/cards/food/cake.png'),value:"EntityCake",soundFile:"media/voices/cake.ogg"});});

// lib/game/entities/food/carrot.js
ig.baked=true;ig.module('game.entities.food.carrot').requires('game.entities.card').defines(function(){EntityCarrot=EntityCard.extend({underCard:new ig.Image('media/cards/food/carrot.png'),value:"EntityCarrot",soundFile:"media/voices/carrot.ogg"});});

// lib/game/entities/food/apple.js
ig.baked=true;ig.module('game.entities.food.apple').requires('game.entities.card').defines(function(){EntityApple=EntityCard.extend({underCard:new ig.Image('media/cards/food/apple.png'),value:"EntityApple",soundFile:"media/voices/apple.ogg"});});

// lib/game/settings/settings.js
ig.baked=true;ig.module('game.settings.settings').requires('game.entities.animals.bird','game.entities.animals.cat','game.entities.animals.crab','game.entities.animals.dog','game.entities.animals.duck','game.entities.animals.fish','game.entities.animals.giraffe','game.entities.animals.lion','game.entities.animals.penguin','game.entities.animals.pig','game.entities.animals.snake','game.entities.animals.spider','game.entities.animals.turtle','game.entities.food.coffee','game.entities.food.cake','game.entities.food.carrot','game.entities.food.apple').defines(function(){baseEasyX=352;baseEasyY=176;baseMediumX=292;baseMediumY=96;baseHardX=221;baseHardY=20;baseButtonX='';Settings=ig.Class.extend({easyGrid:[{x:baseEasyX,y:baseEasyY},{x:baseEasyX+204,y:baseEasyY},{x:baseEasyX+(204*2),y:baseEasyY},{x:baseEasyX,y:baseEasyY+240},{x:baseEasyX+204,y:baseEasyY+240},{x:baseEasyX+(204*2),y:baseEasyY+240}],mediumGrid:[{x:baseMediumX,y:baseMediumY},{x:baseMediumX+168,y:baseMediumY},{x:baseMediumX+(168*2),y:baseMediumY},{x:baseMediumX+(168*3),y:baseMediumY},{x:baseMediumX,y:baseMediumY+200},{x:baseMediumX+168,y:baseMediumY+200},{x:baseMediumX+(168*2),y:baseMediumY+200},{x:baseMediumX+(168*3),y:baseMediumY+200},{x:baseMediumX,y:baseMediumY+(200*2)},{x:baseMediumX+168,y:baseMediumY+(200*2)},{x:baseMediumX+(168*2),y:baseMediumY+(200*2)},{x:baseMediumX+(168*3),y:baseMediumY+(200*2)}],hardGrid:[{x:baseHardX,y:baseHardY},{x:baseHardX+132,y:baseHardY},{x:baseHardX+(132*2),y:baseHardY},{x:baseHardX+(132*3),y:baseHardY},{x:baseHardX+(132*4),y:baseHardY},{x:baseHardX+(132*5),y:baseHardY},{x:baseHardX,y:baseHardY+176},{x:baseHardX+132,y:baseHardY+176},{x:baseHardX+(132*2),y:baseHardY+176},{x:baseHardX+(132*3),y:baseHardY+176},{x:baseHardX+(132*4),y:baseHardY+176},{x:baseHardX+(132*5),y:baseHardY+176},{x:baseHardX,y:baseHardY+(176*2)},{x:baseHardX+132,y:baseHardY+(176*2)},{x:baseHardX+(132*2),y:baseHardY+(176*2)},{x:baseHardX+(132*3),y:baseHardY+(176*2)},{x:baseHardX+(132*4),y:baseHardY+(176*2)},{x:baseHardX+(132*5),y:baseHardY+(176*2)},{x:baseHardX,y:baseHardY+(176*3)},{x:baseHardX+132,y:baseHardY+(176*3)},{x:baseHardX+(132*2),y:baseHardY+(176*3)},{x:baseHardX+(132*3),y:baseHardY+(176*3)},{x:baseHardX+(132*4),y:baseHardY+(176*3)},{x:baseHardX+(132*5),y:baseHardY+(176*3)}],animalCards:['EntityBird','EntityCat','EntityCrab','EntityDog','EntityDuck','EntityFish','EntityGiraffe','EntityLion','EntityPenguin','EntityPig','EntitySnake','EntitySpider','EntityTurtle'],foodCards:['EntityCoffee','EntityCake','EntityCarrot','EntityApple','EntityDuck','EntityFish','EntityGiraffe','EntityLion','EntityPenguin','EntityPig','EntitySnake','EntitySpider','EntityTurtle'],difficulty:{easy:3,medium:6,hard:12},init:function(){this.deckAssociation={LevelKitchen:this.animalCards,LevelFood:this.foodCards,LevelTransportation:this.animalCards,LevelAnimals:this.animalCards};}});});
...
// lib/game/entities/screens/animalScreen.js
ig.baked=true;ig.module('game.entities.screens.animalScreen').requires('impact.entity').defines(function(){EntityAnimalScreen=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/animalscenebg.png',1024,768),size:{x:1024,y:768},init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.parent(x,y,settings);}});});

// lib/game/levels/animals.js
ig.baked=true;ig.module('game.levels.animals').requires('impact.image','game.entities.screens.animalScreen').defines(function(){LevelAnimals={"entities":[{"type":"EntityAnimalScreen","x":0,"y":0}],"layer":[]};});
...
// lib/game/entities/elements/baseLogo.js
ig.baked=true;ig.module('game.entities.elements.baseLogo').requires('impact.entity').defines(function(){EntityBaseLogo=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/_homescreen/logotop.png',708,144),size:{x:708,y:144},init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.zIndex=2;this.parent(x,y,settings);},tweenIn:function(){this.tween({pos:{x:156,y:this.inEnd}},0.4).start();},tweenUp:function(){this.tween({pos:{x:156,y:this.upEnd}},0.4).start();}});});

// lib/game/entities/baseDifficultyButton.js
ig.baked=true;ig.module('game.entities.baseDifficultyButton').requires('game.entities.baseButton','game.entities.elements.baseLogo').defines(function(){EntityBaseDifficultyButton=EntityBaseButton.extend({animSheet:new ig.AnimationSheet('media/easybutton.png',216,72),size:{x:216,y:72},update:function(){if(this.clickOnMe()){if(ig.input.pressed('click')){this.currentAnim=this.anims.clicked;}else if(ig.input.released('click')){GAME_STATE.difficultySetting=this.difficultySetting;this.currentAnim=this.anims.idle;ig.game.spawnEntity('EntityHomeButton',8,708);ig.game.spawnEntity('EntityAnimals',40,400);ig.game.spawnEntity('EntityFood',368,400);ig.game.spawnEntity('EntityTransportation',696,400);}}
this.parent();}});});
...
// lib/game/entities/ui/creditCard.js
ig.baked=true;ig.module('game.entities.ui.creditCard').requires('game.entities.baseButton').defines(function(){EntityCreditCard=EntityBaseButton.extend({animSheet:new ig.AnimationSheet('media/creditCard.png',973,725),size:{x:973,y:725},zIndex:10,update:function(){if(this.clickOnMe()){if(ig.input.pressed('click')){this.currentAnim=this.anims.clicked;}else if(ig.input.released('click')){this.currentAnim=this.anims.idle;this.kill();}}
this.parent();}});});

// lib/game/entities/ui/creditsButton.js
ig.baked=true;ig.module('game.entities.ui.creditsButton').requires('game.entities.baseButton','game.entities.ui.creditCard').defines(function(){EntityCreditsButton=EntityBaseButton.extend({animSheet:new ig.AnimationSheet('media/_homescreen/credits.png',700,85),size:{x:700,y:85},update:function(){if(this.clickOnMe()){console.log(creditCard);if(ig.input.pressed('click')){this.currentAnim=this.anims.clicked;}else if(ig.input.released('click')){this.currentAnim=this.anims.idle;var creditCard=ig.game.getEntitiesByType('EntityCreditCard');if(creditCard){this.cardTimer=new ig.Timer();}}}
if(this.cardTimer&&this.cardTimer.delta()>0.25){this.creditCard=ig.game.spawnEntity('EntityCreditCard',30,10);delete this.cardTimer;}
this.parent();}});});
...
ig.baked=true;ig.module('game.entities.elements.cloudThree').requires('impact.entity').defines(function(){EntityCloudThree=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/_homescreen/cloud_3.png',360,120),size:{x:360,y:120},init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.zIndex=4;this.parent(x,y,settings);this.pos.x=-360;this.pos.y=224;myTween=this.tween({pos:{x:1025,y:224}},336,{delay:2,easing:ig.Tween.Easing.Linear.EaseNone}).start();},update:function(){this.parent();if(this.pos.x>1024){ig.game.spawnEntity('EntityCloudThree');this.kill();ig.game.sortEntitiesDeferred();}}});});

// lib/game/entities/elements/logoShadow.js
ig.baked=true;ig.module('game.entities.elements.logoShadow').requires('impact.entity').defines(function(){EntityLogoShadow=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/_homescreen/logoshadow.png',756,36),size:{x:756,y:36},end:624,init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.zIndex=4;this.parent(x,y,settings);},tweenIn:function(){this.tween({pos:{x:136,y:this.end}},0.4).start();}});});

// lib/game/entities/elements/logoBottom.js
ig.baked=true;ig.module('game.entities.elements.logoBottom').requires('game.entities.elements.baseLogo').defines(function(){EntityLogoBottom=EntityBaseLogo.extend({animSheet:new ig.AnimationSheet('media/_homescreen/newLogo.png',708,132),size:{x:708,y:132},inEnd:324,upEnd:204,init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.zIndex=4;this.parent(x,y,settings);}});});

// lib/game/entities/elements/logoMiddle.js
ig.baked=true;ig.module('game.entities.elements.logoMiddle').requires('game.entities.elements.baseLogo').defines(function(){EntityLogoMiddle=EntityBaseLogo.extend({animSheet:new ig.AnimationSheet('media/_homescreen/logomid.png',708,132),size:{x:708,y:132},inEnd:264,upEnd:204,init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.zIndex=3;this.parent(x,y,settings);}});});

// lib/game/entities/elements/logoTop.js
ig.baked=true;ig.module('game.entities.elements.logoTop').requires('game.entities.elements.baseLogo').defines(function(){EntityLogoTop=EntityBaseLogo.extend({animSheet:new ig.AnimationSheet('media/_homescreen/logotop.png',708,132),size:{x:708,y:132},inEnd:204,upEnd:204,init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.zIndex=2;this.parent(x,y,settings);}});});

// lib/game/entities/screens/loadingScreen.js
ig.baked=true;ig.module('game.entities.screens.loadingScreen').requires('impact.entity','plugins.tween','game.entities.ui.easyButton','game.entities.ui.mediumButton','game.entities.ui.hardButton','game.entities.ui.creditsButton','game.entities.elements.cloudOne','game.entities.elements.cloudTwo','game.entities.elements.cloudThree','game.entities.elements.logoShadow','game.entities.elements.logoBottom','game.entities.elements.logoMiddle','game.entities.elements.logoTop').defines(function(){EntityLoadingScreen=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/_homescreen/background.png',1024,768),size:{x:1024,y:768},init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.difficultyTimer=new ig.Timer();this.cloudOne=ig.game.spawnEntity('EntityCloudOne');this.cloudTwo=ig.game.spawnEntity('EntityCloudTwo');this.cloudThree=ig.game.spawnEntity('EntityCloudThree');this.logoTop=ig.game.spawnEntity('EntityLogoTop',156,-144);this.logoMiddle=ig.game.spawnEntity('EntityLogoMiddle',156,-144);this.logoBottom=ig.game.spawnEntity('EntityLogoBottom',156,-144);this.logoShadow=ig.game.spawnEntity('EntityLogoShadow',136,800);ig.game.sortEntitiesDeferred();this.parent(x,y,settings);},update:function(){if(this.difficultyTimer&&this.difficultyTimer.delta()>2.5){this.easyButton=ig.game.spawnEntity('EntityEasyButton',156,88);this.mediumButton=ig.game.spawnEntity('EntityMediumButton',400,88);this.hardButton=ig.game.spawnEntity('EntityHardButton',648,88);this.creditsButton=ig.game.spawnEntity('EntityCreditsButton',160,520);delete this.difficultyTimer;}},draw:function(){this.parent();if(GAME_STATE.difficultySetting){this.moveLogoUp();}else{this.moveLogoIn();}},moveLogoIn:function(){this.logoTop.tweenIn();this.logoMiddle.tweenIn();this.logoBottom.tweenIn();this.logoShadow.tweenIn();},moveLogoUp:function(){this.logoTop.tweenUp();this.logoMiddle.tweenUp();this.logoBottom.tweenUp();if(this.easyButton){this.logoBottom.anims.idle=new ig.Animation(new ig.AnimationSheet('media/_homescreen/newLogo.png',708,144),1,[0]);this.creditsButton.kill();this.logoShadow.kill();this.easyButton.kill();this.mediumButton.kill();this.hardButton.kill();}}});});
...
ig.baked=true;ig.module('game.levels.sceneselect').requires('impact.image','game.entities.screens.loadingScreenBlur').defines(function(){LevelSceneselect={"entities":[{"type":"EntityLoadingScreenBlur","x":0,"y":0}],"layer":[]};});

// lib/game/entities/screens/foodScreen.js
ig.baked=true;ig.module('game.entities.screens.foodScreen').requires('impact.entity').defines(function(){EntityFoodScreen=ig.Entity.extend({animSheet:new ig.AnimationSheet('media/foodbg.png',1024,768),size:{x:1024,y:768},init:function(x,y,settings){this.addAnim('idle',1,[0]);this.currentAnim=this.anims.idle;this.parent(x,y,settings);}});});

// lib/game/levels/food.js
ig.baked=true;ig.module('game.levels.food').requires('impact.image','game.entities.screens.foodScreen').defines(function(){LevelFood={"entities":[{"type":"EntityFoodScreen","x":0,"y":0}],"layer":[]};});
...
ig.baked=true;ig.module('game.entities.baseSceneButton').requires('game.entities.baseButton').defines(function(){EntityBaseSceneButton=EntityBaseButton.extend({animSheet:new ig.AnimationSheet('media/base.png',288,288),size:{x:288,y:288},update:function(){if(this.clickOnMe()){if(ig.input.released('click')){GAME_STATE.sceneSetting=this.scene;GAME_STATE.sceneName=this.sceneName;this.currentAnim=this.anims.idle;ig.system.setGame(MyGame);}}
this.parent();}});});

// lib/game/entities/ui/animals.js
ig.baked=true;ig.module('game.entities.ui.animals').requires('game.entities.baseSceneButton').defines(function(){EntityAnimals=EntityBaseSceneButton.extend({animSheet:new ig.AnimationSheet('media/animals.png',288,288),size:{x:288,y:288},init:function(x,y,settings){if(!ig.global.wm){this.scene=LevelAnimals;}
this.sceneName='LevelAnimals';this.parent(x,y,settings);}});});

// lib/game/entities/ui/transportation.js
ig.baked=true;ig.module('game.entities.ui.transportation').requires('game.entities.baseSceneButton').defines(function(){EntityTransportation=EntityBaseSceneButton.extend({animSheet:new ig.AnimationSheet('media/transportation.png',288,288),size:{x:288,y:288},init:function(x,y,settings){if(!ig.global.wm){this.scene=LevelTransportation;}
this.sceneName='LevelTransportation';this.parent(x,y,settings);}});});

// lib/game/entities/ui/food.js
ig.baked=true;ig.module('game.entities.ui.food').requires('game.entities.baseSceneButton').defines(function(){EntityFood=EntityBaseSceneButton.extend({animSheet:new ig.AnimationSheet('media/food.png',288,288),size:{x:288,y:288},init:function(x,y,settings){if(!ig.global.wm){this.scene=LevelFood;}
this.sceneName='LevelFood';this.parent(x,y,settings);}});});
...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','impact.font','plugins.preloader','game.settings.settings','game.utility','game.levels.animals','game.levels.loadingscreen','game.levels.sceneselect','game.levels.food','game.levels.transportation','game.entities.ui.dither','game.entities.ui.greatJob','game.entities.ui.homeButton','game.entities.ui.resetButton','game.entities.ui.animals','game.entities.ui.transportation','game.entities.ui.food','game.entities.ui.sceneSelectButton').defines(function(){GAME_STATE={difficultySetting:"",sceneSetting:"",sceneName:""};MyGame=ig.Game.extend({settings:new Settings(),utility:new Utility(),matchOne:"",matchTwo:"",cardSpawnQueue:[],init:function(){this.currentDeck=this.settings.deckAssociation[GAME_STATE.sceneName];this.loadLevel(GAME_STATE.sceneSetting);this.createBoard(this.settings.difficulty[GAME_STATE.difficultySetting]);this.createHud();},createHud:function(){var x=ig.system.width/2;ig.game.spawnEntity('EntityHomeButton',50,110);ig.game.spawnEntity('EntitySceneSelectButton',50,190);},clearHud:function(){ig.game.getEntitiesByType('EntityHomeButton')[0].kill();ig.game.getEntitiesByType('EntitySceneSelectButton')[0].kill();},update:function(){if(this.cardSpawnQueue.length){if(this.spawnCounter.delta()>0.06){var card=this.cardSpawnQueue.shift();this.spawnEntity(card[0],card[1],card[2]);this.spawnCounter.reset();}}
if(this.cardCount===0){var getBg=ig.game.getEntitiesByType('EntityDither')[0];var x=ig.system.width/2,y=ig.system.height/2;if(!getBg){this.clearHud();ig.game.spawnEntity('EntityDither',0,0);ig.game.spawnEntity('EntityGreatJob',25,100);ig.game.spawnEntity('EntityHomeButton',x-58,y-100);ig.game.spawnEntity('EntityResetButton',x-58,y);ig.game.spawnEntity('EntitySceneSelectButton',x-58,y+100);}}
this.parent();},createBoard:function(cardCount){this.cardCount=cardCount*2;var shuffledCards=this.getRandomCards(cardCount);var animalCardsCopy=this.utility.shuffle(shuffledCards.concat(shuffledCards));var grid=this.settings[GAME_STATE.difficultySetting+'Grid'];this.spawnCounter=new ig.Timer();for(var i=0;i<grid.length;i++){this.cardSpawnQueue.push([animalCardsCopy[i],grid[i].x,grid[i].y]);}},getRandomCards:function(count){return this.utility.shuffle(this.currentDeck).slice(0,count);}});StartScreen=ig.Game.extend({init:function(){ig.music.add('media/music/deci-bells.mp3');ig.music.volume=0.2;ig.music.play();ig.input.bind(ig.KEY.MOUSE1,'click');this.loadLevel(LevelLoadingscreen);this.firstLoad=true;}});SceneSelectScreen=ig.Game.extend({init:function(){this.loadLevel(LevelSceneselect);ig.game.spawnEntity('EntityHomeButton',8,708);ig.game.spawnEntity('EntityAnimals',40,400);ig.game.spawnEntity('EntityFood',368,400);ig.game.spawnEntity('EntityTransportation',696,400);}});EasyGame=MyGame.extend({difficulty:"easy"});MediumGame=MyGame.extend({difficulty:"medium"});HardGame=MyGame.extend({difficulty:"hard"});ig.main('#canvas',StartScreen,60,1024,768,1);});